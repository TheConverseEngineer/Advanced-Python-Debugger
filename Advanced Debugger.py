"""THIS IS AN ADVANCED VERSION OF MY DEBUGGER - TheConverseEngineer"""
...
class Debug:    #The debug class
    ...
    def Head(self, frame, end, cont = ""):
        if end:
            return str('Line '+ str(self.prevLine - self.FirstLine) + cont + ' (Programe Line ' + str(self.prevLine) + ') (iteration ' + str(self.UpdateLineNo(self.prevLine)) + '):') #last line
        else:
            return str('Line '+ str(self.prevLine - self.FirstLine) + ' (Programe Line ' + str(self.prevLine) + ') (iteration ' + str(self.UpdateLineNo(self.prevLine)) + '): ')
